...
@section('admin')
  ...
  <div class="content-wrapper">
	...
	<div class="box-body">							
		...
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Students Number</p>
			<h3 class="text-white mb-0 font-weight-500">{{-- $users->where('usertype', 'Student')->count()--}} <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
		</div>
	</div>
</div>
</div>
